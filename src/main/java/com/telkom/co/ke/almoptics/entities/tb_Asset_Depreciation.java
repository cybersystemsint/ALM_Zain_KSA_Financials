 ...
 */
@Entity
@Table(name = "`tb_Asset_Depreciation`", indexes = {
    @Index(name = "PRIMARY", columnList = "recordId", unique = false)})
public class tb_Asset_Depreciation implements Serializable {
    ...
    public tb_Asset_Depreciation(int recordId, Date recordDatetime, String assetCode, String depreciationDate, double assetBookValue, double accumulatedDepreciation) {
    }
