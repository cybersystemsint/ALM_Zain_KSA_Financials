...
@Entity
@Table(name = "`Asset`", indexes = { @Index(name = "PRIMARY", columnList = "recordNo", unique = false) })
public class Asset implements Serializable {
	...
	public Asset(int recordNo, Date recordDateTime, String assetCode, String inventoryId, String serialNumber,
			float purchasePrice, String poId, String createdBy, boolean approved, String approvedBy, Date approvalDate,
			String supplierId, Date purchaseDate, String status, String warrantyDetails, String warrantExpiryDate,
			String details, String depreciationModel, String salvageValue, String usefulLife) {
